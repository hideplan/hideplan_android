...
import { Drawer, Snackbar, Menu, Divider, Dialog, Paragraph, Surface } from 'react-native-paper';
...
import { HeaderIcon, HeaderIconMenu, HeaderIconEmpty, DrawerHeader, DrawerRow, DrawerRowGroup, DrawerSubtitle, AppHeader } from "../../customComponents.js";
import {
  Container,
  Header,
  Left,
  ...
  render() {
    ...
    return (
      ...
      onLayout={(event) => {
        ...
        if (this.state.defaultHeight == "") {
          this.setState({ itemHeight: new Animated.Value(layout.height)})
          this.setState({  defaultHeight: layout.height })
        }
      }}>
      <View
        style={{
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        menuIcon={() => { return <HeaderIconMenu darkTheme={this.props.screenProps.darkTheme} ripple={this.props.screenProps.colors.ripple} headerIcon="menu" color={this.props.screenProps.colors.gray} headerFunction={() => {
          this.MyDrawer.open()
        }} /> }}
        icons={[<Menu
          dark
        dark={true}
          ...
          theme={{dark:true, mode:"exact", colors: {surface: this.props.screenProps.colors.modal, text: this.props.screenProps.colors.text}}}
          anchor={
            <HeaderIcon darkTheme={this.props.screenProps.darkTheme} ripple={this.props.screenProps.colors.ripple} headerIcon="dots-vertical" color={this.props.screenProps.colors.gray} headerFunction={() => {
              this._openMenu()
            }} />
          }
        ><Menu.Item 
        ...
        <Menu.Item disabled={!this.state.hasCompletedTasks}
          ...
          <Menu.Item onPress={() => {NavigationService.navigate("ListsSettings"), this._closeMenu()}} title="Rename list" />
  ...
  />
        ...
        />
              ...
              {this.props.screenProps.lists &&
                  this.props.screenProps.tagName && this.props.screenProps.tasks && this.MyDrawer ?
                <DrawerRowGroup
        ...
        <Modal 
         ...
         > 
        <Dialog
             theme={{dark: true, colors: {primary: this.props.screenProps.colors.primary, surface: this.props.screenProps.colors.modal, text: this.props.screenProps.colors.text} }}
             visible={this.state.dialogVisible}
             onDismiss={this._hideDialog}>
            <Dialog.Title>Delete completed</Dialog.Title>
            <Dialog.Content theme={{dark: true, colors: {primary: this.props.screenProps.colors.primary} }}>
              <Paragraph  theme={{dark: true, colors: {primary: this.props.screenProps.colors.primary} }}>{`Do you want to delete all completed tasks from list "${this.props.screenProps.tagName.list}"?`}</Paragraph>
            </Dialog.Content>
            <Dialog.Actions>
            <Button onPress={this._hideDialog}>Cancel</Button>
              <Button  onPress={this.deleteCompletedTasks}>Confirm</Button>
            </Dialog.Actions>
          </Dialog>
          </Modal>

          <Modal 
         onRequestClose={this._hideSortDialog} 
         visible={this.state.dialogSortVisible} 
         transparent={true}
         onDismiss={this._hideSortDialog}
         > 
        <Dialog
             theme={{dark: true, colors: {primary: this.props.screenProps.colors.primary, surface: this.props.screenProps.colors.modal, text: this.props.screenProps.colors.text} }}
             visible={this.state.dialogSortVisible}
            ...
            />
            <Dialog.Actions>
            <Button onPress={this._hideSortDialog}>Cancel</Button>
            </Dialog.Actions>
          </Dialog>
          </Modal>
      </View>
