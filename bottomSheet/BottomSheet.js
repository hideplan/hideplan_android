...
import { Dimensions, View, Text, Modal, TouchableOpacity, TouchableWithoutFeedback, Animated, PanResponder } from "react-native";
      ...
      onPanResponderRelease: (e, gestureState) => {
        ...
        if ( gestureState.dy > 0) {
          if (gestureState.dy < 100) {
            ...
            this.state.pan.y.setOffset(0);

          } else {
            this.setModalExpanded(false);
            this.setState({ isExpanded: false})
            this.state.pan.y.setOffset(0);
